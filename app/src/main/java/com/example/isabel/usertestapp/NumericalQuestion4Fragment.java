...
public class NumericalQuestion4Fragment extends android.support.v4.app.Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        btn0 = (Button)view.findViewById(R.id.btnZeroNumerical4);
        btn1 = (Button) view.findViewById(R.id.btnOneNumerical4);
        btn2 = (Button) view.findViewById(R.id.btnTwoNumerical4);
        btn3 = (Button) view.findViewById(R.id.btnThreeNumerical4);
        btn4 = (Button) view.findViewById(R.id.btnFourNumerical4);
        btn5 = (Button) view.findViewById(R.id.btnFiveNumerical4);
        btn6 = (Button) view.findViewById(R.id.btnSixNumerical4);
        btn7 = (Button) view.findViewById(R.id.btnSevenNumerical4);
        btn8 = (Button) view.findViewById(R.id.btnEightNumerical4);
        btn9 = (Button) view.findViewById(R.id.btnNineNumerical4);
        btnPoint = (Button) view.findViewById(R.id.btnPointNumerical4);
        btnBackspace = (ImageButton) view.findViewById(R.id.backspaceNumerical4);
        //final ImageButton btnReset = (ImageButton) view.findViewById(R.id.btnReset4);
        dontKnow = (Button) view.findViewById(R.id.btnNumerical4DontKnow);
        input = (EditText) view.findViewById(R.id.inputNumerical4);
        swipe = (TextView) view.findViewById(R.id.numerical4Continue);
        question = (TextView) view.findViewById(R.id.numericalQuestion4);
