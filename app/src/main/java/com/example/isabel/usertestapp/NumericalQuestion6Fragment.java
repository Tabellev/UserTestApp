...
public class NumericalQuestion6Fragment extends android.support.v4.app.Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = (RelativeLayout)inflater.inflate(R.layout.fragment_numerical_question6, container, false);
        btn0 = (Button)view.findViewById(R.id.btnZeroNumerical6);
        btn1 = (Button) view.findViewById(R.id.btnOneNumerical6);
        btn2 = (Button) view.findViewById(R.id.btnTwoNumerical6);
        btn3 = (Button) view.findViewById(R.id.btnThreeNumerical6);
        btn4 = (Button) view.findViewById(R.id.btnFourNumerical6);
        btn5 = (Button) view.findViewById(R.id.btnFiveNumerical6);
        btn6 = (Button) view.findViewById(R.id.btnSixNumerical6);
        btn7 = (Button) view.findViewById(R.id.btnSevenNumerical6);
        btn8 = (Button) view.findViewById(R.id.btnEightNumerical6);
        btn9 = (Button) view.findViewById(R.id.btnNineNumerical6);
        btnPoint = (Button) view.findViewById(R.id.btnPointNumerical6);
        btnBackspace = (ImageButton) view.findViewById(R.id.backspaceNumerical6);
        btnReset = (ImageButton) view.findViewById(R.id.btnReset6);
        dontKnow = (Button) view.findViewById(R.id.btnNumerical6DontKnow);
        input = (EditText) view.findViewById(R.id.inputNumerical6);
        swipe = (TextView) view.findViewById(R.id.numerical6Continue);
        mProgressBar=(ProgressBar)view.findViewById(R.id.progressbar9);
    ...
    public NumericalQuestion6Fragment(){}

    public static NumericalQuestion6Fragment newInstance(int index) {
        NumericalQuestion6Fragment f = new NumericalQuestion6Fragment();
