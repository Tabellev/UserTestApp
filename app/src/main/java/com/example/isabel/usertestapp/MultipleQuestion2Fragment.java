...
public class MultipleQuestion2Fragment extends android.support.v4.app.Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = (RelativeLayout)inflater.inflate(R.layout.fragment_multiple_question2, container, false);
        btnOption1 = (Button)view.findViewById(R.id.btnMultiple2AnsOne);
        btnOption2 = (Button) view.findViewById(R.id.btnMultiple2AnsTwo);
        btnOption3 = (Button) view.findViewById(R.id.btnMultiple2AnsThree);
        btnOption4 = (Button) view.findViewById(R.id.btnMultiple2AnsFour);
        dontKnow = (Button) view.findViewById(R.id.multiple2DontKnow);
        swipe = (TextView) view.findViewById(R.id.multipleChoice2Continue);
        question = (TextView) view.findViewById(R.id.multipleAnswerQuestion2);
