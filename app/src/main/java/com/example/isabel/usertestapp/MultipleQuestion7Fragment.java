...
public class MultipleQuestion7Fragment extends android.support.v4.app.Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = (RelativeLayout)inflater.inflate(R.layout.fragment_multiple_question7, container, false);
        btnOption1 = (Button)view.findViewById(R.id.btnMultiple7AnsOne);
        btnOption2 = (Button) view.findViewById(R.id.btnMultiple7AnsTwo);
        btnOption3 = (Button) view.findViewById(R.id.btnMultiple7AnsThree);
        btnOption4 = (Button) view.findViewById(R.id.btnMultiple7AnsFour);
        dontKnow = (Button) view.findViewById(R.id.multiple7DontKnow);
        swipe = (TextView) view.findViewById(R.id.multipleChoice7Continue);
        mProgressBar=(ProgressBar)view.findViewById(R.id.progressbar7);
    ...
    public MultipleQuestion7Fragment(){}

    public static MultipleQuestion7Fragment newInstance(int index) {
        MultipleQuestion7Fragment f = new MultipleQuestion7Fragment();
