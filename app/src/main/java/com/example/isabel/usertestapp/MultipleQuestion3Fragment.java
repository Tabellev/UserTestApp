...
public class MultipleQuestion3Fragment extends android.support.v4.app.Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = (RelativeLayout)inflater.inflate(R.layout.fragment_multiple_question3, container, false);
        btnOption1 = (Button)view.findViewById(R.id.btnMultiple3AnsOne);
        btnOption2 = (Button) view.findViewById(R.id.btnMultiple3AnsTwo);
        btnOption3 = (Button) view.findViewById(R.id.btnMultiple3AnsThree);
        btnOption4 = (Button) view.findViewById(R.id.btnMultiple3AnsFour);
        dontKnow = (Button) view.findViewById(R.id.multiple3DontKnow);
        swipe = (TextView) view.findViewById(R.id.multipleChoice3Continue);
        question = (TextView) view.findViewById(R.id.multipleAnswerQuestion3);
